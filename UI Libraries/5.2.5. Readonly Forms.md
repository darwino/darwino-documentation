...
- Readonly
  The editable control is replaced a piece of static HTML, generally the value is being diaplayed as text. For controls with a lookup, like a combobox, the lable is displayed.
